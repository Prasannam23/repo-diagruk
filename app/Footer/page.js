    ...
    <footer className="bg-black text-white py-8 md:py-16">
      <div className='container mx-auto flex flex-col md:flex-row items-center'>
        <div className="text-center md:w-9/12 md:mr-8">
          ...
          <Link href="/Contact_US" className='my-2 text-1xl'>
            <button className="bg-white my-8 h-10 w-40 text-purple-600 font-bold py-2 px-4 rounded md:w-auto md:py-3 md:px-6">Contact Us</button></Link>
        </div>
        <div className='md:w-3/12 mt-8 md:mt-0'>
          <div className='flex flex-col text-center justify-center text-color-white'>
            ...
            <Link href="/About_us" className='my-2 text-1xl'>About Us
            </Link>
          </div>
        </div>
      </div>
