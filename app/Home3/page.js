...
const CardContent = () => {
  return (
    <>
      <p className='absolute text-bold lg:text-lg lg:text-2xl ml-2 lg:ml-4 leading-4 lg:leading-10 font-medium'>Basics of NABL</p>
...
const Home3 = () => {
  return (
    <>
    <div className='flex justify-center border-dashed border-2 border-purple-600 ... mt-16 py-8 lg:py-px'>
