...
const CardContent = () => {
  return (
    <>
      <p className='absolute text-bold text-base lg:text-lg lg:text-2xl ml-2 lg:ml-4 leading-4 lg:leading-10 lg:font-medium'>Basics of NABL</p>
      <p className='ml-2 mt-4 lg:ml-4 lg:mt-6 lg:mt-10 text-semibold lg:text-lg leading-none'>Get to know the basics</p>
      <p className='mt:ml-4 ml-2 lg:mt-2 font-bold lg:font-semibold lg:bold text-purple-700'>Read more</p>
    </>
  );
};
...
const CardImage = ({ imagePath, imageAlt }) => {
  return (
<Image className='w-[295px] lg:w-[346px] h-[195px] lg:h-[346px] rounded-xl border border-solid lg:ml-3 mt-px lg:mt-3' src={sense} alt={imageAlt} />  );
};
...
const Home2 = () => {
  return (
    <>
    <div className='flex border-dashed border-2 border-purple-600 ... justify-center mt-32 py-8 lg:py-px'>
      ...
      <div class='flex-col lg:flex-col lg:mt-28 mr-8 lg:ml-px lg:max-h-full h-32 lg:max-h-screen justify-center items-end'>
